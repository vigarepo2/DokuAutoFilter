...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/DokuBots')
            ],
            [
                InlineKeyboardButton('⚡Start Bot In PM⚡', url=f"https://t.me/DokuFilterBot?start=start"),
            ],
            [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚡Start Bot In PM⚡', url='https://t.me/DokuFilterBot?start=start') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
